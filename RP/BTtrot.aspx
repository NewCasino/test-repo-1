...
<script language=VBScript runat=server>
	...
	Dim DT As String
	Dim RType As String = "H"	'R=Thoroughbred H=Harness
...
<% If Request("DT") = "" Then  %>
  ...
  <html>
	  ...
	  <script>
		top.setTitle("Trading Report (Bet Type on Trots)"); curVNL = ""; 
	  </script>
	  <body>
...
<% Else
	...
	<div class=MTG>
		...
		<div class="STS ST3">BY BET TYPE (TROTS)</div>
									...
									If sNN(RV(I)) Then
										For Each R As String In RV(I).ToString.Split(vbLf)
											If R <> "" And Left(R, 1) <> "#" Then
												...
												Catch : End Try		'Operator '*' is not defined for type 'Double' and type 'DBNull'.  - TBF !!
											End If
										Next
									End If
								Next
